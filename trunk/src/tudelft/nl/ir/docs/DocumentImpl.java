...
public class DocumentImpl implements Document{
	...
	public String getContent(int start, int end) {
		...
		if (end > m_DocLength) end = m_DocLength;
	...
	public boolean contains(String term) {
		...
		if (this.m_Term_2_Position_Map.containsKey(term)) return true;
		else return false;		
	}
	...
	public List<Integer> getTermPositions(String term) {
		if (this.m_Term_2_Position_Map.containsKey(term)) return this.m_Term_2_Position_Map.get(term);
		else return null;
	}
